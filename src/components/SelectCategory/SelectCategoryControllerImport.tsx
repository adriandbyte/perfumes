...
type SelectCategoriesControllerImportProps = {
  error?: string
  field: ControllerRenderProps<ImportArticlesListInputs, "categoryId">
}
export default function SelectCategoryControllerImport({
  error,
  field: { value, onChange },
}: SelectCategoriesControllerImportProps) {
